...
A master prompt for an AI coding agent (Cursor, or similar) that sets up a free, locally running AI chat app you own forever - no subscriptions, no API keys. It is not a tutorial you run by hand.

## How to use this prompt

1. Open a fresh agent chat in Cursor on the Mac or Windows PC where you want the app installed.
