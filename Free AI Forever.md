...
A master prompt for an AI coding agent that sets up a free, locally running AI chat app you own forever - no subscriptions, no API keys. It is not a tutorial you run by hand.
